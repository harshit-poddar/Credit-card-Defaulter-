...
class Model_Finder:
        ...
        try:
            ...
            self.logger_object.log(self.file_object,
                                   'XGBoost best params: ' + str(
                                       self.grid.best_params_) + '. Exited the get_best_params_for_xgboost method of '
                                                                 'the Model_Finder class')
            return self.xgb
        except Exception as e:
            self.logger_object.log(self.file_object,
                                   'Exception occured in get_best_params_for_xgboost method of the Model_Finder '
                                   'class. Exception message:  ' + str(
                                       e))
            self.logger_object.log(self.file_object,
    ...
    def get_best_model(self, train_x, train_y, test_x, test_y):
        ...
        try:
            ...
            self.logger_object.log(self.file_object,
                                   'Exception occured in get_best_model method of the Model_Finder class. Exception '
                                   'message:  ' + str(
                                       e))
            self.logger_object.log(self.file_object,
