...
class Preprocessor:
    ...
    def remove_unwanted_spaces(self, data):
        ...
        try:
            ...
            self.logger_object.log(self.file_object,
                                   'Unwanted spaces removal Successful.Exited the remove_unwanted_spaces method of '
                                   'the Preprocessor class')
            return self.df_without_spaces
        except Exception as e:
            self.logger_object.log(self.file_object,
                                   'Exception occurred in remove_unwanted_spaces method of the Preprocessor class. '
                                   'Exception message:  ' + str(
                                       e))
            self.logger_object.log(self.file_object,
                                   'unwanted space removal Unsuccessful. Exited the remove_unwanted_spaces method of '
                                   'the Preprocessor class')
            raise Exception()
    ...
    def remove_columns(self, data, columns):
        ...
        try:
            ...
            self.logger_object.log(self.file_object,
                                   'Exception occured in remove_columns method of the Preprocessor class. Exception '
                                   'message:  ' + str(
                                       e))
            self.logger_object.log(self.file_object,
    ...
    def separate_label_feature(self, data, label_column_name):
        ...
        try:
            ...
            self.logger_object.log(self.file_object,
                                   'Exception occured in separate_label_feature method of the Preprocessor class. '
                                   'Exception message:  ' + str(
                                       e))
            self.logger_object.log(self.file_object,
    ...
    def impute_missing_values(self, data, cols_with_missing_values):
        """
                    ...
                    Description: This method replaces all the missing values in the Dataframe using Categorical Imputer.
    ...
    def scale_numerical_columns(self, data):
        ...
        try:
            ...
            self.logger_object.log(self.file_object,
                                   'scaling for numerical values successful. Exited the scale_numerical_columns '
                                   'method of the Preprocessor class')
            return self.scaled_num_df

        except Exception as e:
            self.logger_object.log(self.file_object,
                                   'Exception occured in scale_numerical_columns method of the Preprocessor class. '
                                   'Exception message:  ' + str(
                                       e))
            self.logger_object.log(self.file_object,
                                   'scaling for numerical columns Failed. Exited the scale_numerical_columns method '
    ...
    def encode_categorical_columns(self, data):
        ...
        try:
            ...
            self.logger_object.log(self.file_object,
                                   'encoding for categorical values successful. Exited the encode_categorical_columns '
                                   'method of the Preprocessor class')
            return self.cat_df
            ...
            self.logger_object.log(self.file_object,
                                   ...
                                   'Exception message:  ' + str(
                                       e))
            self.logger_object.log(self.file_object,
                                   'encoding for categorical columns Failed. Exited the encode_categorical_columns '
                                   'method of the Preprocessor class')
            raise Exception()
    ...
    def handle_imbalanced_dataset(self, x, y):
        ...
        try:
            ...
            self.logger_object.log(self.file_object,
                                   'dataset balancing successful. Exited the handle_imbalanced_dataset method of the '
                                   'Preprocessor class')
            return self.x_sampled, self.y_sampled

        except Exception as e:
            self.logger_object.log(self.file_object,
                                   'Exception occurred in handle_imbalanced_dataset method of the Preprocessor class. '
                                   'Exception message:  ' + str(
                                       e))
            self.logger_object.log(self.file_object,
                                   'dataset balancing Failed. Exited the handle_imbalanced_dataset method of the '
                                   'Preprocessor class')
            raise Exception()
